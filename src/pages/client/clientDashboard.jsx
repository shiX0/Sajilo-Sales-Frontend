...
const clientDashboard = () => {
  const product = {
    ...
    name: "Dog food “Liven” - Junior version",
    description: "Pescado, verduras y arroz con aceite de oliva",
    price: 25.98,
    size: "250g",
  };
  return (
    <div className="flex">
      <div className="flex h-screen w-16 flex-col justify-between border-e bg-white dark:bg-zinc-900">
        <div>
